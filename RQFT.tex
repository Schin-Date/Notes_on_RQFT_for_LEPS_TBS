...
\input{\myqftsrcdirectory/InteractingFields2}
\label{sec:InteractingFields2}
%\input{\mainqftsrcdirectory/ScYNNamp}
\input{\myqftsrcdirectory/ScYNNamp}
...
\input{\myqftsrcdirectory/photon/free_photon}
\input{\myqftsrcdirectory/photon/QED_photon}
...
\input{\myqftsrcdirectory/Appendices/Wick}

\newpage
\section{Dirac Matrices and Spinors}
\label{sec:App_Dirac}
%\input{\mainqftsrcdirectory/A_Dirac}
\input{\myqftsrcdirectory/Appendices/DiracApp}
...
\bibitem{ref:Bogoliubov} N.~N.~Bogoliubov and D.~V.~Shirkov, {\it "Introduction to the Theory of Quantized Fields"},
John Wiley \& Sons, 1976.
\bibitem{ref:Weinberg} S.~Weinberg, {\it "The Quantum Theory of Fields I, II"}, Cambridge Univ. Press, 1995.
\bibitem{ref:Mandl-Shaw} Franz Mandl and Graham Shaw, {\it "Quantum Field Theory"}, John Wiley \& Sons, 2010.
