...
In the following, we will take the case where $\psi$ is fermionic and obeys
%include in our consideration the case that $\psi$ is fermion obeying
anti-commutation relationships into account.
%instead of commutation ones in Eq. (\ref{eqn:complscalarcancomm}).
