\noindent
massless vector, neutral\\
Vectors belong to the adjoint representation of the Poincar\'e Group SL(2,C).
%\subsubsection{Classical Electomagnetic Field}

\subsubsection{Classical Theory}
Maxwell's equations, the set of classical field equations of the electromagnetism,
is written
...
and the field strength tensor $F^{\mu \nu}$ is defined in terms of four electromagnetic potential
$A^\mu(x) = (\phi, \bld{A})$ as
\begin{eqnarray}
F^{\mu \nu} = \partial^{\mu} A^{\nu} - \partial^{\nu} A^{\mu}\,.
\label{eqn:FdefinedbyA}
\end{eqnarray}
$F^{\mu \nu}$ is apparently an antisymmetric tensor.
It is related with
...
\footnote{%------------------------------------------ footnote 
This notation is especially convenient to express outer products of spatial vectors.}
It follows from the definition (\ref{eqn:FdefinedbyA}) that a relationship
\begin{eqnarray}
...
\label{eqn:homMxwF}
\end{eqnarray}
holds as an identity. This one is called the Bianchi identity
and equivalent with homogeneous Maxwell's equations,
that are Coulomb's law for magnetic field and Faraday's law.
Remaining two laws, Coulomb's law for electric field and
Amp\`ere-Maxwell's law are ivolved in Eq. (\ref{eqn:inhomMxwF}),
which is inhomogeneous.

Since homogeneous Maxwell's equations are automatically satisfied by
the definition (\ref{eqn:FdefinedbyA}),
problems of electromagnetism reduce themselves to solving inhomogeneous
...
Eq. (\ref{eqn:LF2expressbyEB}) shows
\footnote{%------------------------------- footnote >>
\begin{eqnarray}
...
%=====================================================================
\subsubsection{Quantization of Free Field}
%------------------------------------------------------------------------------------- Coulomb
\noindent
\underline{Coulomb gauge}\\
...
%=====================================================================
\subsubsection{Interacting Photon Field}
