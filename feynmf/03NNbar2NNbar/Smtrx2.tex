...
\begin{fmffile}{NNbarbyPi}
	\begin{fmfgraph*}(40,20)
			...
			%------------------------------------------------- labels on paths
			\fmfi{phantom,label=$k$,label.side=left,label.dist=2mm}{updwpth}
			%\fmfi{phantom,label=$1/\sqrt{(2\pi)^3}$,label.side=left,label.dist=2mm}{uppthin}
			%\fmfi{phantom,label=$1/\sqrt{(2\pi)^3}$,label.side=left,label.dist=2mm}{uppthout}
			%\fmfi{phantom,label=$1/\sqrt{(2\pi)^3}$,label.side=right,label.dist=2mm}{dwpthin}
			%\fmfi{phantom,label=$1/\sqrt{(2\pi)^3}$,label.side=right,label.dist=2mm}{dwpthout}
			%------------------------------------------------- momentum arrows
			\fmfcmd{%
				style_def marrowa expr p = drawarrow 
					subpath (1/4, 3/4) of p shifted 6 down withpen pencircle scaled 0.4;
					label.bot(btex $p_a$ etex, point 0.5 of p shifted 6 down); enddef;
				   }
			\fmf{marrowa}{i2,v2}
			\fmfcmd{%
				style_def marrowone expr p = drawarrow 
					subpath (1/4, 3/4) of p shifted 6 down withpen pencircle scaled 0.4;
					label.bot(btex $p_1$ etex, point 0.5 of p shifted 6 down); enddef;
				   }
			\fmf{marrowone}{v2,o2}
			\fmfcmd{%
				style_def marrowb expr p = drawarrow 
					subpath (1/4, 3/4) of p shifted 6 up withpen pencircle scaled 0.4;
					label.top(btex $p_b$ etex, point 0.5 of p shifted 6 up); enddef;
				   }
			\fmf{marrowb}{i1,v1}
			\fmfcmd{%
				style_def marrowtwo expr p = drawarrow 
					subpath (1/4, 3/4) of p shifted 6 up withpen pencircle scaled 0.4;
					label.top(btex $p_2$ etex, point 0.5 of p shifted 6 up); enddef;
				   }
			\fmf{marrowtwo}{v1,o1}
			%\fmfcmd{%
			%	style_def marrowk expr p = drawarrow 
			%		subpath (1/4, 3/4) of p shifted 6 left withpen pencircle scaled 0.4;
			%		label.lft(btex $k$ etex, point 0.5 of p shifted 6 left); enddef;
			%	   }
			%\fmf{marrowk}{v2,v1}
			%------------------------------------------------- 			
...
\begin{fmffile}{NNbar2Pi2NNbar}
	\begin{fmfgraph*}(40,20)
			...
			\fmflabel{$\overline{\mathrm N}$}{i1}
			\fmflabel{N}{o1}
			\fmflabel{$\overline{\mathrm N}$}{o2}
			\fmfdotn{v}{2}
			\fmf{dashes,tension=2,label={\large \rm $\pi$},label.side=right}{v1,v2}
			\fmffreeze
			%------------------------------------------------- duplicated vertexes and paths in immediate mode
			\fmfipair{upvin,upvmid,upvout}
			\fmfiset{upvin}{vloc(__i2)}
			...
			\fmfcmd{%
				style_def marrowa expr p = drawarrow 
					subpath (1/4, 3/4) of p shifted 6 left withpen pencircle scaled 0.4;
					label.bot(btex $p_a$ etex, point 0.5 of p shifted 6 left); enddef;
				   }
			\fmf{marrowa}{i2,v1}
			\fmfcmd{%
				style_def marrowone expr p = drawarrow 
					subpath (1/4, 3/4) of p shifted 6 down withpen pencircle scaled 0.4;
					label.bot(btex $p_1$ etex, point 0.5 of p shifted 9 right); enddef;
				   }
			\fmf{marrowone}{v2,o2}
			\fmfcmd{%
				style_def marrowb expr p = drawarrow 
					subpath (1/4, 3/4) of p shifted 8 left withpen pencircle scaled 0.4;
					label.top(btex $p_b$ etex, point 0.5 of p shifted 9 left); enddef;
				   }
			\fmf{marrowb}{i1,v1}
			\fmfcmd{%
				style_def marrowtwo expr p = drawarrow 
					subpath (1/4, 3/4) of p shifted 6 up withpen pencircle scaled 0.4;
					label.top(btex $p_2$ etex, point 0.5 of p shifted 9 right); enddef;
				   }
			\fmf{marrowtwo}{v2,o1}
			%\fmfcmd{%
			%	style_def marrowk expr p = drawarrow 
